...
public class ConvertMoneyStepDef {
    ...
    public void iShouldChooseUSDollar() {
        page.clickElement(page.pcInDollars);
        page.waitTime(1);
    }
